...
public class Temperature : IComparable
{
    ...
    /// <returns>
    /// Less than zero          - The current intstance precededs the object specified by the CompareTo method in the sort order
    ...
    public int CompareTo(object obj)
    {
        ...
        if (otherTemp != null)
        {
            ...
            {
                // It should come before in the list as it is 'colder' than the passed object
                return -1;
            }
    ...
    public Temperature(float _temp) => temperature = _temp;
